...
| **Routes to (mismatch)** | Auto-rebaseline (clear baselines and ledger). Print notice: "MODEL CHANGED — auto-rebaselining for the new model. This is NOT a parameter violation." Routes to **G2**. |
...
| Model identity | DSL hash differs from baseline | Auto-rebaseline (not a violation) |
...
|---|---|---|---|
| G1 — Model identity | SHA-256 of `my_dsl.json` matches stored baseline | Auto-rebaseline (not a violation) | Re-baselines and continues |
